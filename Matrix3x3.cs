...
public class Matrix3x3 {
    ...
    public static Matrix3x3 Rotation(float Angle) {
        ...
        return new Matrix3x3(cosAngle, -sinAngle, 0, sinAngle, cosAngle, 0);
    }

    public static Matrix3x3 Translate(Vector2 Direction) {
        return new Matrix3x3(0, 0, Direction.x, 0, 0, Direction.y);
    }

    public static Matrix3x3 Transform(float Angle, Vector2 Direction) {
        float cosAngle = Mathf.Cos(Angle);
        float sinAngle = Mathf.Sin(Angle);
        return new Matrix3x3(cosAngle, -sinAngle, Direction.x, sinAngle, cosAngle, Direction.y);
    }
