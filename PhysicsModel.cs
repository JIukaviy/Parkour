...
public class PhysicsModel {
    ...
    public struct PMObjectSettings {
        ...
        public PMObjectSettings(float lowerAngle, float UpperAngle, GameObject Prefab, float Mass, string Name, int Layer) {
        ...
        public PMObjectSettings(IK.AngleLimits AngleLimits, GameObject Prefab, float Mass, string Name, int Layer) {
        ...
        public PMObjectSettings(GameObject Prefab, float Mass, string Name, int Layer) {
            angleLimits = null;
            prefab = Prefab;
            mass = Mass;
            name = Name;
